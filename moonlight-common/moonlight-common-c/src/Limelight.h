...
// Send a touch event to the streaming machine (Sunshine only).
...
// Send UTF-8 text to the streaming machine. This allows text input
// independent of the host's keyboard layout.
